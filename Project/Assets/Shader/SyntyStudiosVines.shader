Shader "SyntyStudios/Vines" {
	...
	SubShader {
		Tags { "DisableBatching" = "true" "IGNOREPROJECTOR" = "true" "QUEUE" = "AlphaTest+0" "RenderType" = "Opaque" }
		Pass {
			Name "FORWARD"
			Tags { "DisableBatching" = "true" "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "FORWARDBASE" "QUEUE" = "AlphaTest+0" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" }
			Cull Off
			GpuProgramID 20408
			Program "vp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    u_xlat0.x = _WindSpeed * _Time.y;
					    u_xlat2 = (-_Wave) + 1.0;
					    u_xlat0.x = u_xlat0.x / u_xlat2;
					    u_xlat0 = textureLod(_TextureSample0, u_xlat0.xx, 0.0);
					    u_xlat0.xy = u_xlat0.xz * vec2(vec2(_Amount, _Amount));
			...
			Program "fp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat38 = u_xlat38 + u_xlat38;
					    u_xlat3.xyz = vs_TEXCOORD1.xyz * (-vec3(u_xlat38)) + (-u_xlat1.xyz);
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat6.xyz = u_xlat6.xyz + vec3(-0.5, -0.5, -0.5);
					    u_xlat34 = dot(vs_TEXCOORD1.xyz, u_xlat6.xyz);
					    u_xlat34 = u_xlat34 + 0.5;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat37 = u_xlat37 * u_xlat38 + u_xlat3.x;
					    u_xlat38 = dot((-u_xlat1.xyz), vs_TEXCOORD1.xyz);
					    u_xlat38 = u_xlat38 + u_xlat38;
					    u_xlat3.xyz = vs_TEXCOORD1.xyz * (-vec3(u_xlat38)) + (-u_xlat1.xyz);
					    u_xlat4.xyz = vec3(u_xlat37) * _LightColor0.xyz;
		...
		Pass {
			Name "FORWARD"
			Tags { "DisableBatching" = "true" "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "FORWARDADD" "QUEUE" = "AlphaTest+0" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" }
		...
		Pass {
			Name "DEFERRED"
			Tags { "DisableBatching" = "true" "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "DEFERRED" "QUEUE" = "AlphaTest+0" "RenderType" = "Opaque" }
			Cull Off
			GpuProgramID 160320
			Program "vp" {
				SubProgram "d3d11 " {
		...
		Pass {
			Name "ShadowCaster"
			Tags { "DisableBatching" = "true" "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "SHADOWCASTER" "QUEUE" = "AlphaTest+0" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" }
			Cull Off
			GpuProgramID 226168
			Program "vp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat12 = _WindSpeed * _Time.y;
					    u_xlat1.x = (-_Wave) + 1.0;
					    u_xlat12 = u_xlat12 / u_xlat1.x;
					    u_xlat1 = textureLod(_TextureSample0, vec2(u_xlat12), 0.0);
					    u_xlat1.xy = u_xlat1.xz * vec2(vec2(_Amount, _Amount));
					    u_xlat1.xy = in_COLOR0.xx * (-u_xlat1.xy) + u_xlat1.xy;
		...
		Pass {
			Name "Meta"
			Tags { "DisableBatching" = "true" "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "META" "QUEUE" = "AlphaTest+0" "RenderType" = "Opaque" }
			Cull Off
			GpuProgramID 299361
			Program "vp" {
				SubProgram "d3d11 " {
